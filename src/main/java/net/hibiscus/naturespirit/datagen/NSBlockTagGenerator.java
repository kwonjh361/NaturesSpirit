...
public class NSBlockTagGenerator extends FabricTagProvider.BlockTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup arg) {
        ...
        getOrCreateTagBuilder(BlockTags.MAINTAINS_FARMLAND).add(NSMiscBlocks.DESERT_TURNIP_STEM);
        getOrCreateTagBuilder(BlockTags.HOE_MINEABLE).add(
                NSMiscBlocks.SCORCHED_GRASS,
                NSMiscBlocks.TALL_SCORCHED_GRASS,
                BEACH_GRASS,
                TALL_BEACH_GRASS,
                SEDGE_GRASS,
                TALL_SEDGE_GRASS,
        ...
        getOrCreateTagBuilder(BlockTags.PICKAXE_MINEABLE)
                ...
                .add(NSMiscBlocks.CHERT_COAL_ORE, NSMiscBlocks.CHERT_COPPER_ORE, NSMiscBlocks.CHERT_DIAMOND_ORE, NSMiscBlocks.CHERT_GOLD_ORE, NSMiscBlocks.CHERT_EMERALD_ORE, NSMiscBlocks.CHERT_IRON_ORE, NSMiscBlocks.CHERT_LAPIS_ORE, NSMiscBlocks.CHERT_REDSTONE_ORE, PINK_SANDSTONE, SMOOTH_PINK_SANDSTONE, CUT_PINK_SANDSTONE, PINK_SANDSTONE_STAIRS, SMOOTH_PINK_SANDSTONE_STAIRS, PINK_SANDSTONE_SLAB, SMOOTH_PINK_SANDSTONE_SLAB, CUT_PINK_SANDSTONE_SLAB, PINK_SANDSTONE_WALL, CHISELED_PINK_SANDSTONE);
        ...
        getOrCreateTagBuilder(BlockTags.COAL_ORES).add(NSMiscBlocks.CHERT_COAL_ORE);
        getOrCreateTagBuilder(BlockTags.COPPER_ORES).add(NSMiscBlocks.CHERT_COPPER_ORE);
        getOrCreateTagBuilder(BlockTags.DIAMOND_ORES).add(NSMiscBlocks.CHERT_DIAMOND_ORE);
        getOrCreateTagBuilder(BlockTags.GOLD_ORES).add(NSMiscBlocks.CHERT_GOLD_ORE);
        getOrCreateTagBuilder(BlockTags.EMERALD_ORES).add(NSMiscBlocks.CHERT_EMERALD_ORE);
        getOrCreateTagBuilder(BlockTags.IRON_ORES).add(NSMiscBlocks.CHERT_IRON_ORE);
        getOrCreateTagBuilder(BlockTags.LAPIS_ORES).add(NSMiscBlocks.CHERT_LAPIS_ORE);
        getOrCreateTagBuilder(BlockTags.REDSTONE_ORES).add(NSMiscBlocks.CHERT_REDSTONE_ORE);
