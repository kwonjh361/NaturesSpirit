...
public class TerraSolarisParameters extends OverworldBiomeBuilder {
  ...
  ResourceKey<Biome> commonBiomeForestCold = CONFIG.has_woody_highlands ? NSBiomes.WOODY_HIGHLANDS : Biomes.FOREST;

  ResourceKey<Biome> nearBiomeForestCold = CONFIG.has_blooming_highlands ? NSBiomes.BLOOMING_HIGHLANDS : Biomes.FOREST;

  ResourceKey<Biome> commonBiomeTaigaCold = CONFIG.has_woody_highlands ? NSBiomes.WOODY_HIGHLANDS : Biomes.TAIGA;

  ResourceKey<Biome> commonBiomeOldSpruceCold = CONFIG.has_woody_highlands ? NSBiomes.WOODY_HIGHLANDS : Biomes.OLD_GROWTH_SPRUCE_TAIGA;

  ResourceKey<Biome> uncommonBiomeOldPineCold = CONFIG.has_woody_highlands ? null : Biomes.OLD_GROWTH_PINE_TAIGA;

  ResourceKey<Biome> commonPlains = CONFIG.has_sugi_forest ? NSBiomes.SUGI_FOREST : Biomes.PLAINS;

  ResourceKey<Biome> commonForest = CONFIG.has_sugi_forest ? NSBiomes.SUGI_FOREST : Biomes.FOREST;

  ResourceKey<Biome> uncommonNull = CONFIG.has_blooming_sugi_forest ? NSBiomes.BLOOMING_SUGI_FOREST : null;

  ResourceKey<Biome> specialForest = CONFIG.has_blooming_sugi_forest ? NSBiomes.BLOOMING_SUGI_FOREST : Biomes.FOREST;

  ResourceKey<Biome> commonBirchForest = CONFIG.has_sugi_forest ? NSBiomes.SUGI_FOREST : Biomes.BIRCH_FOREST;

  ResourceKey<Biome> uncommonBirchForest = CONFIG.has_sugi_forest ? NSBiomes.SUGI_FOREST : Biomes.OLD_GROWTH_BIRCH_FOREST;

  ResourceKey<Biome> mountainMeadow = CONFIG.has_sugi_forest ? NSBiomes.SUGI_FOREST : Biomes.MEADOW;

  ResourceKey<Biome> windsweptHills = CONFIG.has_sugi_forest ? NSBiomes.SUGI_FOREST : Biomes.WINDSWEPT_HILLS;

  ResourceKey<Biome> windsweptHills2 = CONFIG.has_floral_ridges ? NSBiomes.FLORAL_RIDGES : Biomes.WINDSWEPT_HILLS;

  ResourceKey<Biome> windsweptForest = CONFIG.has_sugi_forest ? NSBiomes.SUGI_FOREST : Biomes.WINDSWEPT_FOREST;

  ResourceKey<Biome> plainsCold = CONFIG.has_shrubby_highlands ? NSBiomes.SHRUBBY_HIGHLANDS : Biomes.PLAINS;

  ResourceKey<Biome> meadowCold = CONFIG.has_blooming_highlands ? NSBiomes.BLOOMING_HIGHLANDS : Biomes.MEADOW;

  ResourceKey<Biome> nullCold = CONFIG.has_arid_highlands ? NSBiomes.ARID_HIGHLANDS : null;

  ResourceKey<Biome> cherryCold = CONFIG.has_arid_highlands ? NSBiomes.ARID_HIGHLANDS : Biomes.CHERRY_GROVE;

  ResourceKey<Biome> windsweptGravelyHillsCold = CONFIG.has_arid_highlands ? NSBiomes.ARID_HIGHLANDS : Biomes.WINDSWEPT_GRAVELLY_HILLS;

  ResourceKey<Biome> windsweptHillsCold = CONFIG.has_shrubby_highlands ? NSBiomes.SHRUBBY_HIGHLANDS : Biomes.WINDSWEPT_HILLS;

  ResourceKey<Biome> windsweptForestCold = CONFIG.has_shrubby_highlands ? NSBiomes.SHRUBBY_HIGHLANDS : Biomes.WINDSWEPT_FOREST;
  ...
  private ResourceKey<Biome> getSteppeBiome(int temperature, int humidity, Climate.Parameter weirdness) {
    if (humidity < 3 && CONFIG.has_arid_highlands) {
      ...
      return humidity < 4 && CONFIG.has_shrubby_highlands ? NSBiomes.SHRUBBY_HIGHLANDS : (CONFIG.has_woody_highlands ? NSBiomes.WOODY_HIGHLANDS : this.pickMiddleBiome(
          temperature,
          humidity,
          weirdness
      ));
