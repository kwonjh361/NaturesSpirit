...
public class PizzaToppingModel extends Model {
  ...
  public static LayerDefinition getTexturedModelData() {
    ...
    modelPartData.addOrReplaceChild("slice0", CubeListBuilder.create().texOffs(-7, 11).addBox(3.0F, 2.04F, 3.0F, 10.0F, 0.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
    modelPartData.addOrReplaceChild("slice1", CubeListBuilder.create().texOffs(-2, 11).addBox(3.0F, 2.04F, 3.0F, 5.0F, 0.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(8, 16).addBox(8.0F, 2.04F, 3.0F, 5.0F, 0.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
