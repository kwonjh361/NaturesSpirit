...
public class NSDataGen implements DataGeneratorEntrypoint {
  ...
  public void buildRegistry(@NotNull RegistrySetBuilder registryBuilder) {
    registryBuilder.add(Registries.CONFIGURED_FEATURE, NSConfiguredFeatures::bootstrap);
    registryBuilder.add(Registries.PLACED_FEATURE, NSPlacedFeatures::bootstrap);
